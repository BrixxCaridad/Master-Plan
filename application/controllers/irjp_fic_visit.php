...
class irjp_fic_visit extends CI_Controller {
	...
	public function index()
	{
		...
		{
			$visit = $this->company_model->get_all_visit();
		}
		foreach ($visit as $v) {
			$hold = array(
				'Sit_No' => $v['Sit_No'],
		...
		$headerdata['title'] = "SITA | Facut in Charge Visitation";
		$this->load->view('include/header', $headerdata);
			$this->load->view('include/ficnavbar2');
		$this->load->view('irjp/fic_visit',$data);
