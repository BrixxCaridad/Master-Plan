...
<img src="<?php echo base_url('assets/printables_bg/application_bg.jpg')?>" width=612 height=936></div>
<div style="position:absolute;left:39.24px;top:50.88px" class="cls_003"><span class="cls_003">IRJP Form #1</span></div>
<div style="position:absolute;left:39.24px;top:62.40px" class="cls_003"><span class="cls_003">Revised 2007</span></div>
<div style="position:absolute;left:166.10px;top:89.78px" class="cls_004"><span class="cls_004">REPUBLIC OF THE PHILIPPINES</span></div>
<div style="position:absolute;left:113.66px;top:103.58px" class="cls_002"><span class="cls_002">TECHNOLOGICAL UNIVERSITY OF THE PHILIPPINES</span></div>
<div style="position:absolute;left:510.70px;top:102.38px" class="cls_002"><span class="cls_002">ID  PHOTO</span></div>
<div style="position:absolute;left:140.90px;top:117.38px" class="cls_002"><span class="cls_002">Office of the Vice President for Academic Affairs</span></div>
<div style="position:absolute;left:513.22px;top:116.18px" class="cls_002"><span class="cls_002">1 ½  X 1 ½</span></div>
...
<div style="position:absolute;left:72.02px;top:315.17px" class="cls_002"><span class="cls_002">Sir:</span></div>
...
<div class="bd-bot cls_003" style="position:absolute;left:180.02px;top:535.99px; font-size: 11px">
	<input disabled type="text" style="width: 111px;; padding-left: 2px; text-align:center" class="cls_003" placeholder=""/>
</div>
...
<div class="bd-bot cls_003" style="position:absolute;left:390.05px;top:535.99px; font-size: 11px">
	<input disabled type="text" style="width: 30px;; padding-left: 2px; text-align:center" class="cls_003" placeholder=""/>
</div>
...
<div class="bd-bot cls_003" style="position:absolute;left:151.90px;top:587.22px; font-size: 11px">
	<input disabled type="text" style="width: 390px;; padding-left: 2px; text-align:center" class="cls_003" placeholder=""/>
</div>
...
<div class="bd-bot cls_003" style="position:absolute;left:138.02px;top:640.62px; font-size: 11px">
	<input disabled type="text" style="width: 215px; padding-left: 2px; text-align:center" class="cls_003" placeholder=""/>
</div>
