         ...
         <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="form-group" style="padding-bottom: 50px">
                        <label class="control-label col-sm-2" for="email" style="font-size: 20px">Name</label>
                            <div class="col-sm-5">          
               ...
               <a href="#savedinfo" class="btn btn-maroon btn-md pull-right" role="button"><span class="glyphicon glyphicon-eye-open" style="padding-right: 4px"></span>Save</a>
                        
                <a href="accountsettings" class="btn btn-maroon btn-md pull-right" role="button"><span class="glyphicon glyphicon-arrow-left" style="padding-right: 4px"></span>Back</a>
