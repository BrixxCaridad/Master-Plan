	...
	<div class="container-fluid">
		...
		<div class="row mt-4">
		 ...
		 <?=form_open_multipart('Requirements/uploadReq', 'id="SubmitReq"');?>
				...
				<div class="row">
					<div class="col-md-12">
						<button class="upload-toggle" type="button">Medical Clearance</button>
						<div class="panel">
							<div class="row">
								<div class="col-md-12">
				...
				<div class="row">
					<div class="col-md-12">
						<button class="upload-toggle" type="button">Personal Community Task Certificate</button>
						<div class="panel">
							<div class="row">
								<div class="col-md-12">
				...
				<div class="row">
					<div class="col-md-12">
						<button class="upload-toggle" type="button">Community Task Certificate of Parent/Guardian</button>
						<div class="panel">
							<div class="row">
								<div class="col-md-12">
				...
				<div class="row">
					<div class="col-md-12">
						<button class="upload-toggle" type="button">Resume</button>
						<div class="panel">
							<div class="row">
								<div class="col-md-12">
				...
				<div class="row">
					<div class="col-md-12">
						<button class="upload-toggle" type="button">Registration Form</button>
						<div class="panel">
							<div class="row">
								<div class="col-md-12">
