...
//,
      function initAutocomplete() {
        var map = new google.maps.Map(document.getElementById('map'), {
          center: {lat: 14.5875552, lng: 120.9817043},
          zoom: 13,
          mapTypeId: 'roadmap'
        });
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBeuJJE8BE3VdyTdyFg8LhJ-z8cfMa8bnI&libraries=places&callback=initAutocomplete"
         async defer></script>
